...
implements MouseListener
{
	...
	private PlotCanvasPopupMenu popupMenu;
	...
	public PlotCanvas(DoubleList1D d, int width, int height,
		boolean storeDataAsReference)
	{
		...
		popupMenu = new PlotCanvasPopupMenu(this);
		add(popupMenu);
	}
...
class PlotCanvasPopupMenu extends PopupMenu
implements ActionListener
{
	...
	public PlotCanvasPopupMenu(PlotCanvas plotCanvas)
	{
		super();
