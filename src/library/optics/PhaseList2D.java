...
/////////////////////////////////////////////////////////////////////////////////////
// define implementations of the interface ComplexList2D that make //
// life a little bit easier when dealing with 2-dimensional light fields           //
/////////////////////////////////////////////////////////////////////////////////////

// this class effectively converts the amplitude distribution passed as the argument to the
// constructor into the corresponding phase distribution
public class PhaseList2D implements DoubleList2D, Serializable
{
	private static final long serialVersionUID = 3354604821499027402L;
	
	public ComplexList2D amplitudeList;
	
	public PhaseList2D(ComplexList2D amplitudeList)
	{
	...
	{
		return Complex.arg(amplitudeList.getElement(i, j));
	}
}
