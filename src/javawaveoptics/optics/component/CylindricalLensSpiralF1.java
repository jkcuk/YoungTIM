 ...
 * @author Johannes
 */
public class CylindricalLensSpiralF1 extends AbstractSimpleOpticalComponent
implements SimplePixelWiseOpticalComponentInterface, Serializable, PropertyChangeListener, ActionListener
{
	...
	public CylindricalLensSpiralF1(
		String name, 
	...
	@Override
	public CylindricalLensSpiralF1 clone()
	{
		return new CylindricalLensSpiralF1(
				name, 
